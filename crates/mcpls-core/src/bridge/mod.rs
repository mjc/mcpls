...
pub(crate) use ast_grep::{StructuralFileSnapshot, StructuralMatch, StructuralSearchResult};
...
pub use translator::{
    ...
    InspectSectionCompleteness, InspectSymbolBatchEntry, InspectSymbolBatchRequest,
    InspectSymbolBatchResult, InspectSymbolBudget, InspectSymbolRequest, InspectSymbolResolution,
    InspectSymbolResult, InspectSymbolSectionKind, InspectSymbolSections, InspectSymbolTarget,
    Location, LocationsResult, OutgoingCallsResult, Position2D, ProjectActivation,
    ProviderSynchronization, Range, ReferenceUse, ReferencesResult, RenameResult,
    SemanticDiscoveryKind, SemanticDiscoveryResult, SemanticResultLimits, ServerCapability,
    ServerLogsResult, ServerMessagesResult, SignatureHelpResult, SourceContext, SourceFrame,
    SupportedWorkspaceEdit, Symbol, SymbolHandle, TextEdit, Translator, TranslatorTemplate,
    WillRenameFilesResult, WorkspaceSymbolBatchEntry, WorkspaceSymbolBatchRequest,
    WorkspaceSymbolBatchResult, WorkspaceSymbolMatchMode, WorkspaceSymbolPageRequest,
