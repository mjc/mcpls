...
impl RequestSpan {
    fn new(
        ...
        let span = tracing::info_span!(
            ...
            batch_snapshot_identity_ms = tracing::field::Empty,
            batch_provider_wall_ms = tracing::field::Empty,
            batch_provider_total_ms = tracing::field::Empty,
            batch_unique_queries = tracing::field::Empty,
            batch_duplicate_queries = tracing::field::Empty,
            batch_cache_hits = tracing::field::Empty,
            batch_provider_requests = tracing::field::Empty,
